...
manual_result = np.empty([1, test_num])
...
if read_flag == 1:
    ...
    for i in range(test_num):
        ...
        manual_result[i] = int(csv_list[i])
    ...
    for i in range(test_num):
        manual_result[0][i] = data3[i][2 * parameter_num]
...
x2, y2 = np.split(data, indices_or_sections=(parameter_num * 2,), axis=1)
