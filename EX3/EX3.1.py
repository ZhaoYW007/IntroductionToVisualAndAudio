...
csv_list_test = csv_read(open('D:/dataset/test_result.csv', 'r', encoding='utf-8'))
...
for i in range(test_num):
    ...
    if result[i] == test_label[i]:
        ...
        print(i, result[i], test_label[i], image_result[i], total_result[i])
